...
from api_gateway.api.router_routes import router as routes_router
from api_gateway.api.router_simulator import router as simulator_router
...
app.include_router(routes_router, prefix="/routes", tags=["routes"], dependencies=_auth)
app.include_router(simulator_router, prefix="/simulator", tags=["simulator"], dependencies=_auth)
